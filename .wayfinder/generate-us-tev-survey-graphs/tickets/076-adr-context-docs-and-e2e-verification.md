...
- [ ] Author `docs/adr/0006-us-tev-survey-graph-generation-workflow.md` following project ADR format (verified 0006 is next available after 0005):
  - **Status**: Accepted
...
- [ ] Perform manual CLI menu dry-run:
