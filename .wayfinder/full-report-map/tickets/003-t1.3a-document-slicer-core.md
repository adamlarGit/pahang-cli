...
- [ ] Sliced files saved to `.temp/temp_parts/<STATION>/` with clean cleanup and `--keep-temp` support.
- [ ] Headless unit tests validating section slicing using `FakeDocumentSlicer`.
